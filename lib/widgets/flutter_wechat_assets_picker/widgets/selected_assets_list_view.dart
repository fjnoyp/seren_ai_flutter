...
import 'package:seren_ai_flutter/widgets/flutter_wechat_assets_picker/widgets/asset_widget_builder.dart';
        ...
        onTap: () async {
          if (value) {
            final List<AssetEntity>? result =
              ...
              themeData: AssetPicker.themeData(theme.colorScheme.primary),
            );
            onResult(result);
          }
        },
