...
class PushNotificationsRepository extends BaseRepository<PushNotificationModel> {
  final Ref ref;

  const PushNotificationsRepository(super.db, this.ref, {super.primaryTable = 'push_notifications'});
