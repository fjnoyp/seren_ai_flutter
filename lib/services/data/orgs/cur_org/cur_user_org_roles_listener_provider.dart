...
final curUserOrgRolesListenerProvider =
    NotifierProvider<CurUserOrgRolesListenerNotifier, List<UserOrgRoleModel>?>(
        CurUserOrgRolesListenerNotifier.new);

class CurUserOrgRolesListenerNotifier
    extends Notifier<List<UserOrgRoleModel>?> {
  ...
  List<UserOrgRoleModel>? build() {
    ...
    final query =
        "SELECT * FROM user_org_roles WHERE user_id = '${watchedCurAuthUser.id}'";
