...
class DebugShiftsFullDayView extends ConsumerWidget {
  const DebugShiftsFullDayView(
    this.shiftId,
    this.day, {
    super.key,
  });
              ...
              return Stack(
                children: [
                    ...
                    return Stack(
                      children: [
                        Positioned(
                          ...
                          child: Divider(
                            color:
                                isMainMarker ? Colors.blue : Colors.grey[300],
                        ...
                        if (isMainMarker)
                          Positioned(
                            top:
                                index * hourHeight, // Adjust for text alignment
                            left: 0,
                            child: SizedBox(
                              width: 15,
                              height: 20,
                  ...
                  ...logs.map((log) {
                    ...
                    final end =
                        log.clockOutDatetime?.toLocal() ?? DateTime.now();
...
class _DrawLineAtCurrentTime extends ConsumerWidget {
  const _DrawLineAtCurrentTime(this.day, this.hourHeight);
  final DateTime day;
...
class _BuildTimeBlock extends ConsumerWidget {
  const _BuildTimeBlock({
    required this.day,
